# Documentação DDD — Oficina Mecânica (entrega)

> **Cópia de entrega** — conteúdo alinhado a `docs/ddd_documentacao_event_storming.md` (versão canónica no repositório).
...
| Ficheiro | Conteúdo |
|----------|-----------|
| `docs/ddd_documentacao_event_storming.md` | Versão canónica: Event Storming, linguagem ubíqua, diagramas Mermaid. |
| `docs/ddd_documentacao_entrega.md` | **Este ficheiro** — cópia para submissão académica, PDF ou importação para Miro. |
